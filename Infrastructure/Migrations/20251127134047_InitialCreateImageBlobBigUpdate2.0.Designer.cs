...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251127134047_InitialCreateImageBlobBigUpdate2.0")]
    partial class InitialCreateImageBlobBigUpdate20
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Entities.Product", b =>
                {
                    ...
                    b.ToTable("Products", t =>
                        {
                            t.HasCheckConstraint("CK_Product_BasePrice", "[BasePrice] >= 0");

                            t.HasCheckConstraint("CK_Product_PriceRange", "[MaxPrice] IS NULL OR [MaxPrice] >= [BasePrice]");
                        });
                });
            ...
            modelBuilder.Entity("Core.Entities.Shop", b =>
                {
                    ...
                    b.ToTable("Shops", t =>
                        {
                            t.HasCheckConstraint("CK_Shop_CommissionRate", "[CommissionRate] >= 0 AND [CommissionRate] <= 100");
                        });
                });
            ...
            modelBuilder.Entity("Core.Entities.UserAddress", b =>
                {
                    ...
                    b.HasIndex("UserId", "IsDefault")
                        .IsUnique()
                        .HasFilter("([IsDefault] = CAST(1 AS bit))");
